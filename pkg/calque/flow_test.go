...
func TestFlow_Run_StreamingScenarios(t *testing.T) {
	// This test function delegates to individual test functions below
	// to avoid high cyclomatic complexity
	t.Run("Scenario1_LongStreamWithOutputConverter_KeepsUp", testScenario1LongStreamKeepsUp)
	t.Run("Scenario2_LongStreamWithOutputConverter_Slow", testScenario2LongStreamSlow)
	t.Run("Scenario3_LongStreamWithNilOutput", testScenario3LongStreamNilOutput)
	t.Run("Scenario4_ShortInputWithStringOutput", testScenario4ShortInputStringOutput)
	t.Run("Scenario5_ShortInputWithNilOutput", testScenario5ShortInputNilOutput)
	t.Run("Scenario6_StreamingWithIOWriter", testScenario6StreamingIOWriter)
	t.Run("MemoryLeak_Prevention_NilOutput", testMemoryLeakPreventionNilOutput)
	t.Run("RealTime_Streaming_OutputConverter", testRealTimeStreamingOutputConverter)
}

func testScenario1LongStreamKeepsUp(t *testing.T) {
...
func testScenario2LongStreamSlow(t *testing.T) {
...
func testScenario3LongStreamNilOutput(t *testing.T) {
...
func testScenario4ShortInputStringOutput(t *testing.T) {
...
func testScenario5ShortInputNilOutput(t *testing.T) {
...
func testScenario6StreamingIOWriter(t *testing.T) {
...
func testMemoryLeakPreventionNilOutput(t *testing.T) {
...
func testRealTimeStreamingOutputConverter(t *testing.T) {
